...
This SIMD path is an unpublished source-tree change. The currently published zenpix 1.0.2 package remains scalar; the five-environment GitHub Actions run, packed artifacts, npm packages, and production use have not yet been verified for this change.
