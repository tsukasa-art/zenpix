...
このリポジトリで準備中のpackage versionは`1.1.0`です。npm registry上の公開versionはpublishするまで更新されません。
...
package rootは公開済み1.0.0と同じbaseline版のraw Emscripten factoryです。1.1.0でも次のimportは変更しません。
